...
<body>
  <div class="row">
    ...
    <div>
      <ul id="menu">
        <li>Hello <span style="color:red;"><?php $user = $_SESSION['username'];
                                            print $user; ?> </span> </li>
        <li> Amount to paid : $ <?php $total = $_SESSION['totalprice'];
                                print $total; ?></li>
        <li>Your order id : # <?php $orderid = $_SESSION['orderid'];
                              print $orderid; ?> </li>
      </ul>
    </div>
    <!-- ... -->
  ...
  <form name="success" style="visibility:hidden;" action="" method="get">
    <div class="row" style=" margin-left:30%;">
      <b>
        <h3>Alas! Your card has validated</h3>
      </b>
      <div class="col-md-10">
  ...
  <script>
    function success() {
      if (window.tokentosend != undefined) {
        ...
        document.forms["success"].style.visibility = "hidden";
      }
